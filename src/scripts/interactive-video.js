 ...
 *
 * @class H5P.BrightcoveInteractiveVideo
 ...
 *
 * @param {number} index
 * @returns {H5P.BrightcoveInteractiveVideoInteraction}
 */
  ...
  interaction.on('display', function (event) {
    ...
    if (parameters.action.library) {
      ...
      if(css_file.includes('storage/brightcove/css')){
        ...
        if (interactionttype.includes("IVHotspot")){
          var text = $($interactioncontent).find("p")[0].innerText.replace('&#039;', `'`) ;
 ...
 *
 * @param {H5P.BrightcoveInteractiveVideoInteraction[]} requiredInteractions
 ...
 *
 * @return {H5P.BrightcoveInteractiveVideoInteraction[]} visible interactions
 */
